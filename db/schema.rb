...
ActiveRecord::Schema.define(:version => 20140124195858) do
  ...
  create_table "saved_listings", :id => false, :force => true do |t|
    t.integer  "user_id"
    t.integer  "listing_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  add_index "saved_listings", ["user_id", "listing_id"], :name => "index_saved_listings_on_user_id_and_listing_id", :unique => true
